...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.SEM_SEG_HEAD.CONVS_DIM = [256, 256, 256, 256]
    cfg.MODEL.SEM_SEG_HEAD.TRANSFORMER_ENC_LAYERS = [6, 6, 6, 6]
    cfg.MODEL.SEM_SEG_HEAD.MLP_RATIO = [ 4.0, 4.0, 4.0, 4.0 ]
    cfg.MODEL.SEM_SEG_HEAD.NHEADS = [ 8, 8, 8, 8 ]
