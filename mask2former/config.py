...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.MASK_FINER.NUM_OBJECT_QUERIES = 100
    ...
    cfg.MODEL.MASK_FINER.ORACLE_TEACHER_RATIO = 0.0
    cfg.MODEL.MASK_FINER.MASK_DECODER_ALL_LEVELS = False
    ...
    cfg.MODEL.MR.DYNAMIC_UPSAMPLING_THRESHOLD = [0.0, 0.005, 0.01, 0.015, 0.0, 0.0, 0.0]
