...
class MRUD(nn.Module):
    def __init__(self, backbones, backbone_dims, out_dim, oracle_teacher_ratio, all_out_features, n_scales, bb_in_feats):
        super().__init__()
...
class UpDownBackbone(MRUD, Backbone):
    def __init__(self, cfg, input_shape):
        ...
        all_backbones = []
        bb_in_feats = [[None], ["res5"], ["res5", "res4"], ["res5", "res4", "res3"], ["res5", "res4", "res3"], ["res5", "res4"], ["res5"]]
