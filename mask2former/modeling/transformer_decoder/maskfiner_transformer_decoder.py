...
from ..backbone.point_utils import upsample_feature_shepard, find_pos_indices_in_pos, upsample_shepard_cdist
    ...
    def create_disagreement_mask(self, outputs_mask, outputs_class):
        ...
        for b in range(cls_i.shape[0]):
            ...
            for i, c in enumerate(cls_unique):
                ...
                batch_cls_mask = nn.functional.sigmoid(batch_cls_mask)
